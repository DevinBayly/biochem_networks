    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 211, 2, 5377);
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "min", "0");
    			attr_dev(input0, "max", "7");
    			add_location(input0, file, 216, 6, 5470);
    			attr_dev(input1, "type", "range");
    			attr_dev(input1, "min", "0");
    			attr_dev(input1, "max", "7");
    			add_location(input1, file, 222, 6, 5599);
    			add_location(label0, file, 214, 4, 5425);
    			attr_dev(input2, "type", "number");
    			attr_dev(input2, "min", "0");
    			attr_dev(input2, "max", "3000");
    			add_location(input2, file, 231, 6, 5770);
    			attr_dev(input3, "type", "range");
    			attr_dev(input3, "min", "0");
    			attr_dev(input3, "max", "3000");
    			add_location(input3, file, 232, 6, 5845);
    			add_location(label1, file, 229, 4, 5738);
    			attr_dev(input4, "type", "number");
    			attr_dev(input4, "min", "-10000");
    			attr_dev(input4, "max", "400");
    			add_location(input4, file, 236, 6, 5969);
    			attr_dev(input5, "type", "range");
    			attr_dev(input5, "min", "-10000");
    			attr_dev(input5, "max", "400");
    			add_location(input5, file, 237, 6, 6048);
    			add_location(label2, file, 234, 4, 5930);
    			attr_dev(input6, "type", "checkbox");
    			add_location(input6, file, 241, 6, 6172);
    			add_location(label3, file, 239, 4, 6137);
    			attr_dev(button, "id", "download");
    			add_location(button, file, 243, 4, 6234);
    			attr_dev(div1, "id", "labels");
    			add_location(div1, file, 212, 2, 5402);
    			attr_dev(div2, "id", "holder");
    			attr_dev(div2, "class", "svelte-ercrp1");
    			add_location(div2, file, 209, 0, 5356);
    			add_location(p, file, 246, 0, 6294);
    			add_location(canvas, file, 248, 2, 6359);
    			attr_dev(div3, "id", "legend");
    			add_location(div3, file, 247, 0, 6339);
    		},
