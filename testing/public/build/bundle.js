...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 209, 2, 5313);
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "min", "0");
    			attr_dev(input0, "max", "7");
    			add_location(input0, file, 214, 6, 5406);
    			attr_dev(input1, "type", "range");
    			attr_dev(input1, "min", "0");
    			attr_dev(input1, "max", "7");
    			add_location(input1, file, 220, 6, 5535);
    			add_location(label0, file, 212, 4, 5361);
    			attr_dev(input2, "type", "number");
    			attr_dev(input2, "min", "0");
    			attr_dev(input2, "max", "3000");
    			add_location(input2, file, 229, 6, 5706);
    			attr_dev(input3, "type", "range");
    			attr_dev(input3, "min", "0");
    			attr_dev(input3, "max", "3000");
    			add_location(input3, file, 230, 6, 5781);
    			add_location(label1, file, 227, 4, 5674);
    			attr_dev(input4, "type", "number");
    			attr_dev(input4, "min", "-10000");
    			attr_dev(input4, "max", "400");
    			add_location(input4, file, 234, 6, 5905);
    			attr_dev(input5, "type", "range");
    			attr_dev(input5, "min", "-10000");
    			attr_dev(input5, "max", "400");
    			add_location(input5, file, 235, 6, 5984);
    			add_location(label2, file, 232, 4, 5866);
    			attr_dev(input6, "type", "checkbox");
    			add_location(input6, file, 239, 6, 6108);
    			add_location(label3, file, 237, 4, 6073);
    			attr_dev(button, "id", "download");
    			add_location(button, file, 241, 4, 6170);
    			attr_dev(div1, "id", "labels");
    			add_location(div1, file, 210, 2, 5338);
    			attr_dev(div2, "id", "holder");
    			attr_dev(div2, "class", "svelte-ercrp1");
    			add_location(div2, file, 207, 0, 5292);
    			add_location(p, file, 244, 0, 6230);
    			add_location(canvas, file, 246, 2, 6295);
    			attr_dev(div3, "id", "legend");
    			add_location(div3, file, 245, 0, 6275);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let createGraph = (data, svgArg) => {
    		...
    		const node = zoom_group.append("g").attr("stroke", "#fff").attr("stroke-width", 1.5).selectAll("circle").data(nodes).join("circle").attr("r", d => d.value).attr("fill", "black").call(drag().on("start", dragstarted).on("drag", dragged).on("end", dragended));
    		...
    		let ticked = () => {
    			...
    			zoom_group.selectAll("text").attr("x", d => d.x + d.value).attr("y", d => d.y + d.value).attr("dy", 5);
    		};
