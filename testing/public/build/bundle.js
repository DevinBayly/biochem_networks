...
var app = (function () {
    ...
    /* src/Graph.svelte generated by Svelte v3.20.1 */
    ...
    function create_fragment(ctx) {
    	...
    	function input2_input_handler() {
    		...
    		/*input2_input_handler*/ ctx[13].call(input2);
    	}

    	function input4_input_handler() {
    		input4_updating = true;
    		/*input4_input_handler*/ ctx[15].call(input4);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text("Min shared protein count\n      ");
    			...
    			t7 = text("Repulsion Strength\n      ");
    			input4 = element("input");
    			t8 = space();
    			input5 = element("input");
    			t9 = space();
    			label3 = element("label");
    			t10 = text("Stop animation\n      ");
    			input6 = element("input");
    			t11 = space();
    			button = element("button");
    			button.textContent = "Download svg";
    			attr_dev(div0, "id", "container");
    			add_location(div0, file, 272, 2, 7190);
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "min", "0");
    			attr_dev(input0, "max", "7");
    			add_location(input0, file, 277, 6, 7283);
    			attr_dev(input1, "type", "range");
    			attr_dev(input1, "min", "0");
    			attr_dev(input1, "max", "7");
    			add_location(input1, file, 283, 6, 7412);
    			add_location(label0, file, 275, 4, 7238);
    			attr_dev(input2, "type", "number");
    			attr_dev(input2, "min", "0");
    			attr_dev(input2, "max", "3000");
    			add_location(input2, file, 292, 6, 7583);
    			attr_dev(input3, "type", "range");
    			attr_dev(input3, "min", "0");
    			attr_dev(input3, "max", "3000");
    			add_location(input3, file, 293, 6, 7658);
    			add_location(label1, file, 290, 4, 7551);
    			attr_dev(input4, "type", "number");
    			attr_dev(input4, "min", "-10000");
    			attr_dev(input4, "max", "400");
    			add_location(input4, file, 297, 6, 7782);
    			attr_dev(input5, "type", "range");
    			attr_dev(input5, "min", "-10000");
    			attr_dev(input5, "max", "400");
    			add_location(input5, file, 298, 6, 7861);
    			add_location(label2, file, 295, 4, 7743);
    			attr_dev(input6, "type", "checkbox");
    			add_location(input6, file, 302, 6, 7985);
    			add_location(label3, file, 300, 4, 7950);
    			attr_dev(button, "id", "download");
    			add_location(button, file, 304, 4, 8047);
    			attr_dev(div1, "id", "labels");
    			add_location(div1, file, 273, 2, 7215);
    			attr_dev(div2, "id", "holder");
    			attr_dev(div2, "class", "svelte-1onhogt");
    			add_location(div2, file, 270, 0, 7169);
    		},
    		...
    		m: function mount(target, anchor, remount) {
    			...
    			set_input_value(input0, /*threshold*/ ctx[3]);
    			append_dev(label0, t2);
    			append_dev(label0, input1);
    			set_input_value(input1, /*threshold*/ ctx[3]);
    			append_dev(div1, t3);
    			append_dev(div1, label1);
    			append_dev(label1, t4);
    			append_dev(label1, input2);
    			set_input_value(input2, /*distanceTool*/ ctx[0]);
    			append_dev(label1, t5);
    			append_dev(label1, input3);
    			set_input_value(input3, /*distanceTool*/ ctx[0]);
    			append_dev(div1, t6);
    			append_dev(div1, label2);
    			append_dev(label2, t7);
    			append_dev(label2, input4);
    			set_input_value(input4, /*strengthTool*/ ctx[2]);
    			append_dev(label2, t8);
    			append_dev(label2, input5);
    			set_input_value(input5, /*strengthTool*/ ctx[2]);
    			append_dev(div1, t9);
    			append_dev(div1, label3);
    			append_dev(label3, t10);
    			append_dev(label3, input6);
    			input6.checked = /*off*/ ctx[1];
    			append_dev(div1, t11);
    		...
    		p: function update(ctx, [dirty]) {
    			if (!input0_updating && dirty & /*threshold*/ 8) {
    				set_input_value(input0, /*threshold*/ ctx[3]);
    			}

    			input0_updating = false;

    			if (dirty & /*threshold*/ 8) {
    				set_input_value(input1, /*threshold*/ ctx[3]);
    			}

    			if (!input2_updating && dirty & /*distanceTool*/ 1) {
    				set_input_value(input2, /*distanceTool*/ ctx[0]);
    			}

    			input2_updating = false;

    			if (dirty & /*distanceTool*/ 1) {
    				set_input_value(input3, /*distanceTool*/ ctx[0]);
    			}

    			if (!input4_updating && dirty & /*strengthTool*/ 4) {
    				set_input_value(input4, /*strengthTool*/ ctx[2]);
    			}

    			input4_updating = false;

    			if (dirty & /*strengthTool*/ 4) {
    				set_input_value(input5, /*strengthTool*/ ctx[2]);
    			}
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let createGraph = (data, svgArg) => {
    		...
    		simulation$1.stop();
    		console.log(simulation$1);
    		let forces = simulation$1.force("link", link(links).id(d => d.id).distance(1000)).force("charge", manyBody().strength(-509)).force("center", center$1(width / 2, height / 2));
    		...
    		// make a color
    		const link$1 = zoom_group.append("g").attr("stroke", "#999").attr("stroke-opacity", 0.6).selectAll("line").data(links).join("line").attr("stroke-width", d => d.value * 4).attr("stroke", d => viridis((d.value - threshold) / (max - threshold)));
    		...
    		const sizeScale = linear$2(minMaxVal, radiiRange);
    		const node = zoom_group.append("g").selectAll("circle").data(nodes).join("circle").attr("stroke-width", 3.5).attr("r", d => sizeScale(d.value)).attr("fill-opacity", 0.5).call(drag().on("start", dragstarted).on("drag", dragged).on("end", dragended));

    		// create size legend for nodes
    		let offsets = radiiRange[1] + 50;

    		svg.append("g").attr("class", "legendSize").attr("transform", "translate(" + 150 + "," + offsets + ")");
    		var legendSize = index$4.legendSize().scale(sizeScale).shape("circle").shapePadding(offsets).labelOffset(offsets).orient("horizontal").title("Category size using sum total of unique proteins");
    		svg.select(".legendSize").call(legendSize);

    		// now the edge legend, put at the bottom
    		var viridisScale = sequential(viridis).domain([threshold, max]);

    		svg.append("g").attr("class", "legendViridis").attr("transform", `translate(${30},${1300})`);
    		var legendViridis = index$4.legendColor().shapeWidth(width / (4 * (max - threshold + 1))).shapeHeight(200).cells(max - threshold + 1).labelOffset(180).orient("horizontal").scale(viridisScale).title("Number of shared unique Proteins");
    		svg.select(".legendViridis").call(legendViridis);

    		function dragstarted(d) {
    			if (!event.active) simulation$1.alphaTarget(0.3).restart(); //sets the current target alpha to the specified number in the range [0,1].
    		...
    		zoom_group.append("g").selectAll("text").data(nodes).enter().append("text").text(d => d.id.replace(/hsa.*? /, "")).attr("x", d => d.x + sizeScale(d.value) + 200).attr("y", d => d.y + sizeScale(d.value) + 200).attr("dy", 5);

    		let ticked = () => {
    			link$1.attr("x1", d => d.source.x).attr("y1", d => d.source.y).attr("x2", d => d.target.x).attr("y2", d => d.target.y);
    			node.attr("cx", d => d.x).attr("cy", d => d.y);
    			zoom_group.selectAll("text").attr("x", d => d.x + (Math.floor(d.value / 40) + 1) * 5).attr("y", d => d.y + (Math.floor(d.value / 40) + 1) * 5).attr("dy", 5);
    		};
    		...
    		interval$1(
    			() => {
    				simulation$1.nodes(nodes).force("link", link(links).distance(distanceTool)).force("center", center$1(width / 2, height / 2)).force("charge", manyBody().strength(strengthTool));
    			},
    			2000
    		);

    		svg.call(zoom().extent([[0, 0], [width, height]]).scaleExtent([1, 8]).on("zoom", zoomed));

    		function zoomed() {
    			zoom_group.attr("transform", event.transform);
    		}
    	...
    	function input2_input_handler() {
    		distanceTool = to_number(this.value);
    		$$invalidate(0, distanceTool);
    	}
    	...
    	function input4_input_handler() {
    		strengthTool = to_number(this.value);
    		$$invalidate(2, strengthTool);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ("distanceTool" in $$props) $$invalidate(0, distanceTool = $$props.distanceTool);
    		if ("off" in $$props) $$invalidate(1, off = $$props.off);
    		if ("strengthTool" in $$props) $$invalidate(2, strengthTool = $$props.strengthTool);
    		if ("threshold" in $$props) $$invalidate(3, threshold = $$props.threshold);
    		if ("width" in $$props) width = $$props.width;
    		if ("height" in $$props) height = $$props.height;
    		if ("max" in $$props) max = $$props.max;
    		if ("createGraph" in $$props) createGraph = $$props.createGraph;
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			h1 = element("h1");
    			h1.textContent = "Biochem Networks";
    			t2 = space();
    			p = element("p");
    			...
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "svelte-1kbx16y");
    			add_location(img, file$1, 12, 2, 166);
    			attr_dev(a0, "href", "http://rtdv-intake.glitch.me/");
    			add_location(a0, file$1, 11, 0, 123);
    			add_location(h1, file$1, 14, 0, 205);
    			attr_dev(a1, "href", "https://cbc.arizona.edu/directory/people/brittany-stankavich");
    			add_location(a1, file$1, 17, 2, 313);
    			add_location(p, file$1, 15, 0, 231);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
