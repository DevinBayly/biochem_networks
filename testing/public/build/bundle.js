...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t13 = space();
    			p = element("p");
    			p.textContent = "Number of shared elements in category";
    			t15 = space();
    			div3 = element("div");
    			canvas = element("canvas");
    			attr_dev(div0, "id", "container");
    			add_location(div0, file, 215, 2, 5620);
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "min", "0");
    			attr_dev(input0, "max", "7");
    			add_location(input0, file, 220, 6, 5713);
    			attr_dev(input1, "type", "range");
    			attr_dev(input1, "min", "0");
    			attr_dev(input1, "max", "7");
    			add_location(input1, file, 226, 6, 5842);
    			add_location(label0, file, 218, 4, 5668);
    			attr_dev(input2, "type", "number");
    			attr_dev(input2, "min", "0");
    			attr_dev(input2, "max", "3000");
    			add_location(input2, file, 235, 6, 6013);
    			attr_dev(input3, "type", "range");
    			attr_dev(input3, "min", "0");
    			attr_dev(input3, "max", "3000");
    			add_location(input3, file, 236, 6, 6088);
    			add_location(label1, file, 233, 4, 5981);
    			attr_dev(input4, "type", "number");
    			attr_dev(input4, "min", "-10000");
    			attr_dev(input4, "max", "400");
    			add_location(input4, file, 240, 6, 6212);
    			attr_dev(input5, "type", "range");
    			attr_dev(input5, "min", "-10000");
    			attr_dev(input5, "max", "400");
    			add_location(input5, file, 241, 6, 6291);
    			add_location(label2, file, 238, 4, 6173);
    			attr_dev(input6, "type", "checkbox");
    			add_location(input6, file, 245, 6, 6415);
    			add_location(label3, file, 243, 4, 6380);
    			attr_dev(button, "id", "download");
    			add_location(button, file, 247, 4, 6477);
    			attr_dev(div1, "id", "labels");
    			add_location(div1, file, 216, 2, 5645);
    			attr_dev(div2, "id", "holder");
    			attr_dev(div2, "class", "svelte-ercrp1");
    			add_location(div2, file, 213, 0, 5599);
    			add_location(p, file, 250, 0, 6537);
    			add_location(canvas, file, 252, 2, 6602);
    			attr_dev(div3, "id", "legend");
    			add_location(div3, file, 251, 0, 6582);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let createGraph = (data, svgArg) => {
    		...
    		// make a color
    		const link$1 = zoom_group.append("g").attr("stroke", "#999").attr("stroke-opacity", 0.6).selectAll("line").data(links).join("line").attr("stroke-width", d => d.value).attr("stroke", d => viridis(d.value / max));

    		const node = zoom_group.append("g").attr("stroke", "#fff").attr("stroke-width", 3.5).selectAll("circle").data(nodes).join("circle").attr("r", 20).attr("fill", d => {
    			//first get us down to a 0-10, floor to categorize, then div by 10 to interpolation range 0-1
    			return viridis(Math.floor(d / 40) / 10);
    		}).attr("opacity", 0.5).call(drag().on("start", dragstarted).on("drag", dragged).on("end", dragended));
    		...
    		zoom_group.append("g").selectAll("text").data(nodes).enter().append("text").text(d => d.id.replace(/hsa.*? /, "")).attr("x", d => d.x + d.value).attr("y", d => d.y + d.value).attr("dy", 5);
